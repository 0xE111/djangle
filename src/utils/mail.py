...
def send_mail(
    ...
    **kwargs,
    ...
    subject = engine.from_string('{% extends template %}{% block subject -%}{% endblock %}').render(context).strip('\n ')
    message = engine.from_string('{% extends template %}{% block content -%}{% endblock %}').render(context).strip('\n ')
